                    ...
                    <div class="section-top-border">
                        <div class="row">
                            <div class="col-lg-8 col-md-8">
                                <h3 class="mb-30 title_color">Edit Employee</h3>
                                <!-- Menampilkan Error jika validasi tidak valid -->
                                <div style="color: red;"><?php echo validation_errors(); ?></div>
                                
                                <?php echo form_open("pegawai/ubah/".$pegawai->id); ?>
                                    <div class="mt-10">
                                        <input type="text" name="input_id" placeholder="ID" onfocus="this.placeholder = ''" onblur="this.placeholder = 'ID'" required class="single-input" value="<?php echo set_value('input_id', $pegawai->id); ?>">
                                    </div>
                                    <div class="mt-10">
                                        <input type="text" name="input_name" placeholder="Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" required class="single-input" value="<?php echo set_value('input_name', $pegawai->name); ?>">
                                    </div>
                                    <div class="mt-10">
                                        <input type="email" name="input_email" placeholder="Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required class="single-input" value="<?php echo set_value('input_email', $pegawai->email); ?>">
                                    </div>
                                    <div class="mt-10">
                                        <textarea name="input_address" class="single-textarea" placeholder="Address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Address'" required><?php echo set_value('input_address', $pegawai->address); ?></textarea>
                                    </div>
                                    <div class="mt-10">
                                        <input type="text" name="input_phone" placeholder="Phone" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone'" required class="single-input" value="<?php echo set_value('input_phone', $pegawai->phone); ?>">
                                    </div>
